...
static void wifi_event_handler(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
    ...
    {
        shift_reg_set_led(SHIFT_REG_LED_RED | SHIFT_REG_LED_BLUE);
        esp_wifi_connect();
    }
    else if (event_base == WIFI_EVENT && event_id == WIFI_EVENT_STA_DISCONNECTED)
    {
        ...
        {
            shift_reg_set_led(SHIFT_REG_LED_RED);
    ...
    else if (event_base == IP_EVENT && event_id == IP_EVENT_STA_GOT_IP)
    {
        ...
        s_retry_num = 0;
        shift_reg_set_led(SHIFT_REG_LED_RED | SHIFT_REG_LED_GREEN);
...
esp_err_t wifi_init_sta(void)
{
    ...
    wifi_config_t wifi_config = {
            .sta = {
                    .ssid               = CONFIG_SHELLY_WIFI_SSID,
                    .password           = CONFIG_SHELLY_WIFI_PASSWORD,
